<template>
	<div class="hall">
		...
		<div class="hall_container">
			<div class="hall_container_top" :class="{hall_container_fixed: !showBanner}">
				<div class="message">
					<div class="message_content">
						<div class="swiper-container2">
						    <div class="swiper-wrapper">
						    	...
						    	<div class="swiper-slide message_item">
						    		<img src="@/assets/notice@3x.png">
						    		<p>发布财税需求类型 <span>{{this.typeNum}}</span> 类</p>
						    	</div>
				...
				<div class="filter">
					<div class="filter_item" @click="filter('city')">
						<div class="filter_item_name" :class="{active: filterType == 'city'}">筛选城市</div>
					...
					<div class="filter_item" @click="filter('serve')">
						<div class="filter_item_name" :class="{active: filterType == 'serve'}">筛选服务</div>
					...
					<div class="filter_item" @click="filter('type')">
						<div class="filter_item_name" :class="{active: filterType == 'type'}">筛选类型</div>
						<img class="filter_item_icon" :src="filterType == 'type' ? require('@/assets/arrow-up@3x.png') : require('@/assets/arrow-down@3x.png')">
					</div>
				</div>
				<div class="filter_box" v-show="showFilter">
					<div class="filter_container">
						<div class="filter_left">
							<div class="filter_first" v-for="item in city" :class="{filter_first_active: code == item.code}" @click="select1(item)">{{item.name}}</div>
						</div>
